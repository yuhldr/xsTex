...
% 如果有N列, 可以设置 \sepwidth and \colwidth 满足一下公式
...
\logoleft{\includegraphics[height=7cm]{lzu_logo_white.png}}
	...
	\begin{columns}[t]
		...
		\begin{column}{\colwidth}
			...
			\begin{block}{A block title}
				...
				turpis condimentum urna, quis malesuada sapien arcu eu purus \cite{greaneyAnomalousDissipationSinglewalled2009}.
